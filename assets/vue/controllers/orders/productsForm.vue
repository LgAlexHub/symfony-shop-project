  ...
  <div class="grid grid-cols-5 gap-5 my-2">
    <div class="px-5 col-span-2 h-100 overflow-scroll">
      ...
      <template v-for="orderItem in orderItems" :key="orderItem.item.slug">
        <div
          class="border-2 my-1 border-solid border-lime-950 rounded px-2 py-1 grid grid-cols-3"
        >
          <div class="grid grid-rows-2 col-span-2">
            ...
            <div class="grid grid-cols-3">
              ...
              <div class="inline col-span-2 place-self-center py-1">
                <button
                  class="px-2 border-2 border-solid border-lime-950 rounded"
                  @click="editQuantity(orderItem.item.slug)"
                >
                  <span class="">-</span>
                </button>
                <span
                  class="px-2 mx-1 border-2 border-solid border-lime-950 rounded"
    ...
    <div class="col-span-3 px-2">
      <div
        class="border-2 border-solid border-lime-950 px-2 rounded-sm py-1 w-full"
      >
...
export default {
    ...
    methods: {
        editQuantity(slug, isAddition) {
            ...
            if (!isAddition) {
                this.orderItems[itemIndex].quantity =
                    this.orderItems[itemIndex].quantity > 0
        ...
        onProductAdded(payloadItem) {
            ...
            axios
                .post(`/api/commandes/${this.orderUuid}/ajouter-produit`, bodyFormData)
